...
public class VoiceActivity extends AppCompatActivity {
     ...
     */
    private static final String TWILIO_ACCESS_TOKEN_SERVER_URL = AppSession.baseApiUrl + "call/token?android=1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.dfsl.mybabble.R.layout.activity_voice);
        //setContentView();
        ...
        coordinatorLayout = findViewById(com.dfsl.mybabble.R.id.coordinator_layout);
        callActionFab = findViewById(com.dfsl.mybabble.R.id.call_action_fab);
        hangupActionFab = findViewById(com.dfsl.mybabble.R.id.hangup_action_fab);
        holdActionFab = findViewById(com.dfsl.mybabble.R.id.hold_action_fab);
        muteActionFab = findViewById(com.dfsl.mybabble.R.id.mute_action_fab);
        chronometer = findViewById(com.dfsl.mybabble.R.id.chronometer);
    ...
    private void resetUI() {
        coordinatorLayout.setBackgroundColor(Color.parseColor(BabbleColors.ORANGE));
        callActionFab.hide();
        muteActionFab.setImageDrawable(ContextCompat.getDrawable(VoiceActivity.this, com.dfsl.mybabble.R.drawable.ic_mic_white_24dp));
        holdActionFab.hide();
        holdActionFab.setBackgroundTintList(ColorStateList
                .valueOf(ContextCompat.getColor(this, com.dfsl.mybabble.R.color.colorAccent)));
        muteActionFab.hide();
...
//            APICalls.leavePool();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(com.dfsl.mybabble.R.menu.menu, menu);
        audioDeviceMenuItem = menu.findItem(com.dfsl.mybabble.R.id.menu_audio_device);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == com.dfsl.mybabble.R.id.menu_audio_device) {
            showAudioDevices();
            return true;
        }
        return false;
    ...
    private void showAudioDevices() {
        ...
        if (selectedDevice != null) {
            ...
            new AlertDialog.Builder(this)
                    .setTitle(com.dfsl.mybabble.R.string.select_device)
    ...
    private void updateAudioDeviceIcon(AudioDevice selectedAudioDevice) {
        int audioDeviceMenuIcon = com.dfsl.mybabble.R.drawable.ic_phonelink_ring_white_24dp;

        if (selectedAudioDevice instanceof AudioDevice.BluetoothHeadset) {
            audioDeviceMenuIcon = com.dfsl.mybabble.R.drawable.ic_bluetooth_white_24dp;
        } else if (selectedAudioDevice instanceof AudioDevice.WiredHeadset) {
            audioDeviceMenuIcon = com.dfsl.mybabble.R.drawable.ic_headset_mic_white_24dp;
        } else if (selectedAudioDevice instanceof AudioDevice.Earpiece) {
            audioDeviceMenuIcon = com.dfsl.mybabble.R.drawable.ic_phonelink_ring_white_24dp;
        } else if (selectedAudioDevice instanceof AudioDevice.Speakerphone) {
            audioDeviceMenuIcon = com.dfsl.mybabble.R.drawable.ic_volume_up_white_24dp;
        }
