...
public class IncomingCallNotificationService extends Service {
    ...
    private Notification createNotification(CallInvite callInvite, int notificationId, int channelImportance) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            return new NotificationCompat.Builder(this)
                    .setSmallIcon(com.dfsl.mybabble.R.drawable.ic_call_end_white_24dp)
                    .setContentTitle(getString(com.dfsl.mybabble.R.string.app_name))
    ...
    private Notification buildNotification(String text, PendingIntent pendingIntent, Bundle extras,
        ...
        NotificationCompat.Builder builder =
                new NotificationCompat.Builder(getApplicationContext(), channelId)
                        ...
                        .setExtras(extras)
                        .setAutoCancel(true)
                        .addAction(android.R.drawable.ic_menu_delete, getString(com.dfsl.mybabble.R.string.decline), piRejectIntent)
    ...
    private void accept(CallInvite callInvite, int notificationId) {
        endForeground();
        Intent activeCallIntent = new Intent(this, CallActivity.class);
    ...
    private void handleCancelledCall(Intent intent) {
        ...
        myIntent.setAction(Constants.ACTION_FCM_TOKEN);
    ...
    private void sendCallInviteToActivity(CallInvite callInvite, int notificationId) {
        //This stops us from going into the call properly, why is it here?
